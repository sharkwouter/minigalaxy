...
class TestApi(TestCase):
    ...
    def test_get_download_file_info(self):
        ...
        session = MagicMock()
        response1 = MagicMock()
        response1.status_code = http.HTTPStatus.OK
        response1.json.return_value = {'downlink': 'downlink', 'checksum': 'checksum'}
        response2 = MagicMock()
        response2.status_code = http.HTTPStatus.OK
        response2.text = """<file name="absolute_drift_5f6049d_65600.sh" available="1" notavailablemsg="" md5="dadbd2ca395b26c493763571dad10b7d" chunks="15" timestamp="2023-06-26 09:42:00" total_size="156521363">
...
"""
        ...
        api = Api(config, session)
        api.active_token = True
        api.active_token_expiration_time = time.time() + 3600
        ...
        actual = api.get_download_file_info("")
    ...
    def test_get_xml_data_thows_XmlException(self):
        ...
        response2.text = """<file name="gog_akalabeth_world_of_doom_2.0.0.3.sh" available="1" notavailablemsg="" md5="11a770db592af2ac463e6cdc453b555b" chunks="1" timestamp="2015-07-01 18:38:21" total_size="7569960">
	<chunk id="0" from="0" to="7569959" method="md5">11a770db592af2ac463e6cdc453b555b</chunk>
        ...
        api.get_download_file_info("")

        # Test all kinds of exceptions
        response2.text = """<file available="1" notavailablemsg="" md5="11a770db592af2ac463e6cdc453b555b" chunks="1" timestamp="2015-07-01 18:38:21" total_size="7569960">
	<chunk id="0" from="0" to="7569959" method="md5">11a770db592af2ac463e6cdc453b555b</chunk>
</file>"""
        session.get.side_effect = [
            response1,
        ...
        self.assertRaises(XmlException, api.get_download_file_info, "")

        response2.text = """<file name="gog_akalabeth_world_of_doom_2.0.0.3.sh" available="1" notavailablemsg="" chunks="1" timestamp="2015-07-01 18:38:21" total_size="7569960">
	<chunk id="0" from="0" to="7569959" method="md5">11a770db592af2ac463e6cdc453b555b</chunk>
</file>"""
        session.get.side_effect = [
            response1,
        ...
        response2.text = """<file name="gog_akalabeth_world_of_doom_2.0.0.3.sh" available="1" notavailablemsg="" md5="11a770db592af2ac463e6cdc453b555b" chunks="1" total_size="7569960">
	<chunk id="0" from="0" to="7569959" method="md5">11a770db592af2ac463e6cdc453b555b</chunk>
</file>"""
        session.get.side_effect = [
            response1,
        ...
        response2.text = """<file name="gog_akalabeth_world_of_doom_2.0.0.3.sh" available="1" notavailablemsg="" md5="11a770db592af2ac463e6cdc453b555b" chunks="1" timestamp="2015-07-01 18:38:21">
	<chunk id="0" from="0" to="7569959" method="md5">11a770db592af2ac463e6cdc453b555b</chunk>
</file>"""
        session.get.side_effect = [
            response1,
        ...
        response2.text = """invalid<file name="gog_akalabeth_world_of_doom_2.0.0.3.sh" available="1" notavailablemsg="" md5="11a770db592af2ac463e6cdc453b555b" chunks="1" timestamp="2015-07-01 18:38:21" total_size="7569960">
	<chunk id="0" from="0" to="7569959" method="md5">11a770db592af2ac463e6cdc453b555b</chunk>
</file>"""
        session.get.side_effect = [
            response1,
