...
class Preferences(Gtk.Dialog):
    ...
    switch_keep_window_maximized = Gtk.Template.Child()
    ...
    def __init__(self, parent):
        ...
        self.switch_keep_window_maximized.set_active(Config.get("keep_window_maximized"))
    ...
    def save_pressed(self, button):
        ...
        Config.set("keep_window_maximized", self.switch_keep_window_maximized.get_active())
