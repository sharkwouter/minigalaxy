...
from minigalaxy.dxvk_vkd3d import install_uninstall_dxvk, install_uninstall_vkd3d
    ...
    def ok_pressed(self, button):
        if self.game.is_installed():
            ...
            if self.switch_properties_use_dxvk_vkd3d.get_active():
                ...
                install_uninstall_dxvk("install", self.game)
                install_uninstall_vkd3d("install", self.game)
            else:
                self.game.set_info("use_dxvk", False)
                install_uninstall_dxvk("uninstall", self.game)
                install_uninstall_vkd3d("uninstall", self.game)
