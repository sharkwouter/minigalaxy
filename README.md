...
## Run application without WebkitGTK

If you want to run this application without WebkitGTK dependency, you need to run certain steps:

- Install lgogdownloader and configure it. Please do not ask help here about this tool.
- Obtain the value of **refresh_token** generated by lgogdownloader, located at ~/.config/lgogdownloader/galaxy_tokens.json
- Run minigalaxy once if you haven't. This will create a configuration file.
- Open ~/.config/minigalaxy/config.json and add the key "refresh_token": "**YOUR_REFRESH_TOKEN**".
- Run again minigalaxy.
